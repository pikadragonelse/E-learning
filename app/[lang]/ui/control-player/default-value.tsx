...
export const defaultCustomConfigSlider = {
    handleSize: 9,
    handleSizeHover: 9,
    handleColor: "rgb(234 88 12 / 100)",
    handleActiveColor: "rgb(234 88 12 / 100)",
    dotActiveBorderColor: "rgb(234 88 12 / 100)",
    dotBorderColor: "rgb(234 88 12 / 100)",
    handleLineWidthHover: 2,
    trackBg: "rgb(234 88 12 / 100)",
    trackHoverBg: "rgb(234 88 12 / 100)",
    railBg: "#979797d6",
    railHoverBg: "#707070d6",
};
