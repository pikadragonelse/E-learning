...
export const ItemInstructor: React.FC<ItemInstructor> = ({
    ...
    return (
        <div
            className={`min-w-30 group flex flex-col items-center text-zinc-800 cursor-pointer p-2 hover:text-orange-600 transition-all ${className}`}
        >
            ...
            <h2>{name}</h2>
            <h4 className="text-zinc-600 text-sm font-light group-hover:text-orange-600 transition-all">
                {major}
            </h4>
        </div>
    );
